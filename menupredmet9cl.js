const menuItems = [
    { name: "Українська мова", link: "Ukrain9cl.html" },
    { name: "Історія України. Всесвітня істрія", link: "histori9cl.html" },
    { name: "Алгебра та Геометрія", link: "maths9cl.html"},
    { name: "Фізика", link: "physyk9cl.html"},
    { name: "Хімія", link: "himik9cl.html"},
    { name: "Англійська мова", link: "english9cl.html"},
    { name: "Біологія", link: "biology9cl.html"}
];
document.addEventListener('DOMContentLoaded', function() {
    ...
    function drag(e) {
        ...
        angle = startAngle + mouseDiff * 0.2; // Уменьшен коэффициент для более плавного вращения
        positionItems();
    }
